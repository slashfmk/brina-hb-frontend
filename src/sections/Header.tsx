...
import { FaPlusCircle, FaFemale } from "react-icons/fa";
    ...
    return (
        <header id="header" className="flex flex-col bg-black bg-haircut bg-center bg-cover h-96 text-slate-300">
            ...
            <div className="flex min-h-[64px] flex-row  justify-between px-2 p-4 md:p-4 content-center md:flex-row">
                ...
                <nav className="content-center justify-center hidden md:inline bg-pink-800 p-5 rounded-lg">
            ...
            <div className="flex flex-col place-items-center justify-center my-auto">
                {/*  <h1 className="text-5xl shadow text-center md:text-7xl text-transparent mb-12 font-extrabold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text"> */}
                <h1 className="text-5xl text-center md:text-7xl text-white mb-12 font-extrabold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text">
                    Brina Hair Beauty
                </h1>
